    ...
    return (
        <div className="relative">
            ...
            <div className="flex flex-col max-lg:hidden md:flex-row items-center justify-between bg-gradient-to-r from-[#001158] to-[#00259D] xl:px-20 px-8 py-3 gap-2 text-center md:text-left">
                ...
                <div>
                    <ul className="flex flex-col md:flex-row items-center gap-4 md:gap-10">
                        <li>
                            <a className="flex flex-row items-center gap-2" href="https://www.google.com/maps/place/R.+Euclasio,+552+-+Casa+Blanca,+Vargem+Grande+Paulista+-+SP,+06730-000,+Brasil/@-23.630307,-47.025955,760m/data=!3m1!1e3!4m6!3m5!1s0x94cf09c932d05bbd:0x35355c5a12d449d6!8m2!3d-23.6303075!4d-47.0259551!16s%2Fg%2F11vzr_1gpt?hl=pt-BR&entry=ttu&g_ep=EgoyMDI1MDIwOS4wIKXMDSoASAFQAw%3D%3D">
                                <Icon icon="mdi:map-marker-right" fontSize={20} className="text-white" />
                                <span className="text-white">Rua Euclasio, 552/605 - Casablanca - Vargem Grande Paulista / SP</span>
                            </a>
                        </li>
                        <li>
                            <a className="flex flex-row items-center gap-2" href="https://sistema.netcintra.com.br/radiusnet/cda/login.php">
                                <Icon icon="mdi:user-arrow-right" fontSize={20} className="text-white" />
            ...
            <div className="flex flex-row items-center justify-between xl:px-20 px-8 py-7 relative">
                ...
                <div>
                    <a href="/">
                        <img className="h-16 hover:-translate-y-1 duration-300" src="/images/Logo.png" alt="Logo" />
                    </a>
                </div>
                ...
                {/* Menu (mobile + desktop) */}
                <nav className={`${menuOpen ? "flex" : "hidden"} md:flex absolute md:static top-[100%] left-0 w-full md:w-auto bg-secondary animate-in duration-300 fade-in-50 md:bg-transparent flex-col md:flex-row items-center md:gap-10 gap-6 py-6 md:py-0 z-10`}>
