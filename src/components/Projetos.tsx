    ...
    const projetos = [
        {
            ...
            image: "/images/projeto1.png", // Se você quiser substituir pela imagem específica, basta atualizar o caminho
            reverse: true,
        },
        {
            ...
            image: "/images/projeto2.jpeg", // Atualize o caminho da imagem conforme necessário
            reverse: false,
        },
        {
            ...
            image: "/images/projeto3.png", // Atualize o caminho da imagem conforme necessário
            reverse: true,
        },
        {
            ...
            image: "/images/projeto4.png", // Atualize o caminho da imagem conforme necessário
            reverse: false,
        },
    ];

    return (
        <div className="mt-10 max-lg:mt-0 px-8 -mb-20">
