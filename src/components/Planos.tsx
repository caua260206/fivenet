                                ...
                                <div className="flex justify-center items-center">
                                    <div className="w-96 bg-gradient-to-br drop-shadow-3xl flex flex-col justify-center items-center inset-shadow-white shadow-white/20 from-[#182E89] rounded-2xl border-2 border-[#3B4E96] to-[#001158] px-4 py-8">
                                        ...
                                        <a href="/assine-rapido">
                                            <button className="px-10 py-2 bg-[#008FDF] hover:bg-primary duration-300 flex flex-row items-center gap-2 rounded-2xl mt-4"><Icon className="text-white" icon={`mdi:thunder-outline`} />Assine rápido</button>
                                        </a>
                                        <a href="https://api.whatsapp.com/send?phone=551141581928&text=Ol%C3%A1!%20Vim%20do%20site" target="_blank" rel="noopener noreferrer">
                                            <button className="px-10 py-2 bg-primary hover:bg-secondary duration-300 flex flex-row items-center gap-2 rounded-2xl mt-4"><Icon className="text-white" icon={`mdi:whatsapp`} />Assine Já</button>
                                        </a>
                                    </div>
                                </div>
                            </SwiperSlide>
