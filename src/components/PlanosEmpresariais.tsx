  ...
  const planos = [
    ...
    },
    {
      ...
      beneficios: [
        ...
        {
          icon: `mdi:check-bold`,
          text: `Atendimento prioritário e ágil.
`,
        },
      ],
    },
  ...
  return (
    <div className="mt-14 xl:px-5 px-8 max-lg:px-2 max-lg:text-center">
      {/* Layout dos cards */}
        ...
        {planos.map((plano, index) => (
          ...
          >
            <div className="w-96 bg-gradient-to-br drop-shadow-3xl flex flex-col justify-center items-center inset-shadow-white shadow-white/20 from-[#182E89] rounded-2xl border-2 border-[#3B4E96] to-[#001158] px-6 py-10 relative">
              ...
              <p className="text-white text-sm mb-8 whitespace-pre-line">
                {plano.descricao}
              </p>
