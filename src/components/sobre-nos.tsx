...
A NetCintra Telecom passou a conectar gratuitamente doze escolas na cidade de Vargem Grande Paulista (SP). A ação teve início em janeiro, antes do anúncio oficial, e terá uma duração de três anos, com impacto para mais de 7 mil alunos.`,
            ...
            reverse: false, // Alterado para inverter a posição
        },
        {
...
Fonte: Prefeitura da Estância Turística de São Roque`,
            image: "/images/sao_roque.png", // Se você quiser substituir pela imagem específica, basta atualizar o caminho
            reverse: true,
        },
        {
...
Fonte: Prefeitura da Estância Turística de Ibiúna`,
            image: "/images/ibiuna.png", // Atualize o caminho da imagem conforme necessário
            reverse: false,
        },
    ];
    ...
    return (
        <div className="py-20 max-lg:py-10 px-8">
            ...
            {/* A div do fluxograma, MANTIDA NA POSIÇÃO ORIGINAL, após o map dos projetos. */}
            {/* Apenas a ordem dos itens DENTRO dela mudará para mobile. */}
            <div className="flex flex-col lg:flex-row items-center justify-between gap-12 mb-5">
                {/* DIV DO TEXTO - No desktop ela aparece primeiro (devido à ordem no HTML) */}
                <div className="lg:w-1/2 flex flex-col justify-center max-lg:items-center order-last lg:order-none"> {/* NOVIDADE: 'order-last' para mobile, 'lg:order-none' para desktop */}
                ...
                {/* DIV DA IMAGEM - No mobile ela aparece primeiro por padrão de flex-col. No desktop ela aparece depois do texto. */}
                <div className="lg:w-1/2">
